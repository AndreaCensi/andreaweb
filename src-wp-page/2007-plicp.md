...
Subject_short: PlICP 
PURL: http://purl.org/censi/2007/plicp
Date: 2007-08-22
inMenu: true
orderInfo: -8
...
![image from paper](http://purl.org/censi/research/2007-plicp/paper_plicp.png)
...
- Dataset used for the experiments (provided by [Javier Minguez][javier]):
   - Original log: [original format](http://purl.org/censi/research/2007-plicp/laserazosSM3.off.gz), [Carmen format](http://purl.org/censi/research/2007-plicp/laserazosSM3.log.gz) 
   - Scan matched with PLICP: [Carmen format](http://purl.org/censi/research/2007-plicp/laserazosSM3-sm.log.gz), [PDF](http://purl.org/censi/research/2007-plicp/laserazosSM3-sm.log.pdf)

- Animations used in the video in PDF format:
  - PLICP: [normal](http://purl.org/censi/research/2007-plicp/sm_plicp_normal.pdf) / [zoom](http://purl.org/censi/research/2007-plicp/sm_plicp_zoom.pdf)
  - vanilla ICP: [normal](http://purl.org/censi/research/2007-plicp/sm_icp_normal.pdf) / [zoom](http://purl.org/censi/research/2007-plicp/sm_icp_zoom.pdf)
...
<img class='anim' src='http://purl.org/censi/research/2007-plicp/sm_plicp_zoom_crop.gif'/>
<img class='anim' src='http://purl.org/censi/research/2007-plicp/sm_icp_zoom_crop.gif'/>
...
[pdf-draft]: http://purl.org/censi/research/2008-icra-plicp-draft.pdf
[pdf-final]: http://purl.org/censi/research/2008-icra-plicp.pdf
[video-draft]: http://purl.org/censi/research/2008-icra-plicp-video.mp4

[gpc]: http://purl.org/censi/2007/gpc
[csm]: http://purl.org/censi/2007/csm
